...
const Navbar = ({ setActiveSection, onContactClick }) => {
  ...
  return (
    <nav
      className={`fixed top-4 left-1/2 transform -translate-x-1/2 w-11/12 md:w-4/5 transition-all duration-300 rounded-full py-3 px-6 z-[9999]
        ${scrolled 
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="hidden lg:flex space-x-8 items-center">
          ...
          <a href="#testimonials" className="text-gray-800 hover:text-[#F15A29] transition-colors">OUR WORK</a>
          <a href="#products" className="text-gray-800 hover:text-[#F15A29] transition-colors">PRODUCTS</a>
          <a href="#blog" className="text-gray-800 hover:text-[#F15A29] transition-colors">BLOG</a>
        </div>
      ...
      {mobileOpen && (
        <div className="lg:hidden mt-4 bg-white rounded-lg shadow-lg py-4 px-6 flex flex-col space-y-4">
          ...
          <a href="#testimonials" className="text-gray-800 hover:text-[#F15A29]">OUR WORK</a>
          <a href="#products" className="text-gray-800 hover:text-[#F15A29]">PRODUCTS</a>
          <a href="#blog" className="text-gray-800 hover:text-[#F15A29]">BLOG</a>
        </div>
      )}
    </nav>
  );
